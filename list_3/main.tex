        ...
        \item[12.]
            \begin{enumerate}
                \item Sejam os pontos $(x_0, y_0), \cdots, (x_n, y_n)$,
                    ...
                    Os valores de $M_i$, por sua vez, são encontrados resolvendo
                    ...
                    $$A = \begin{bmatrix}
                            \dfrac{h_0+h_1}{3} & \dfrac{h_1}{6}\\
                            \dfrac{h_1}{6} & \dfrac{h_1+h_2}{3} & \dfrac{h_2}{6} \\
                            &&&\ddots \\
                            &&&\dfrac{h_{n-2}}{3} & \dfrac{h_{n-2}+h_{n-1}}{3}
                        \end{bmatrix}$$
                    $$x = \begin{bmatrix}
                            M_1 \\
                            \vdots \\
                        ...
                        \end{bmatrix}$$
                    $$b = \begin{bmatrix}
                            \dfrac{x_2-x_1}{h_1} - \dfrac{x_1-x_0}{h_0} \\
                            \vdots \\
                            \dfrac{x_n-x_{n-1}}{h_{n-1}} - \dfrac{x_{n-1}-x_{n-2}}{h_{n-2}}
                        \end{bmatrix}$$

                    Faltam apenas $M_0$ e $M_n$, que podem ser
                    deduzidos a partir da expressão de $x'$:

                    $$M_0 = -3nk_0 (\hat{x_0}-x_0) + 3n^2(x_1-x_0) - \dfrac{M_1}{2}$$
                    $$M_n = 3nk_1 (\hat{x_n}-x_n) + 3n^2(x_n-x_{n-1}) - \dfrac{M_{n-1}}{2}$$

                    Ou seja, conseguindo todos os $M_i$, calculamos $c_1$ e $c_2$ e podemos
                    expressar $x(t)$.
